...
function Header() {
  return (
    <div className="absolute contents left-0 top-0" data-name="header">
      <div className="absolute h-[897px] left-0 top-0 w-[1280px]" data-name="thought-catalog-505eectW54k-unsplash 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgThoughtCatalog505EectW54KUnsplash1} />
      </div>
...
function Hero() {
  return (
    <div className="absolute contents left-[21px] top-[828px]" data-name="hero">
      <div className="absolute h-[181px] left-[21px] top-[847px] w-[977px]">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 977 181">
          <path d="M0 0H977V181H0V0Z" fill="var(--fill-0, #AB7559)" id="Rectangle 25" opacity="0.88" />
        </svg>
      </div>
...
function Hero1() {
  return (
    <div className="absolute h-[1183px] left-px top-[1154px] w-[1279px]" data-name="hero">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1279 1183">
        <g id="hero">
          <path d="M0 0H1279V1183H0V0Z" fill="var(--fill-0, #F2D6CC)" id="Rectangle 25" opacity="0.88" />
        </g>
      </svg>
    </div>
  );
...
function Mail() {
  return (
    <div className="absolute contents left-[33px] top-[1510px]" data-name="mail">
      <div className="absolute bg-[#120a08] border border-[#d4896a] border-solid h-[84px] left-[33px] top-[1510px] w-[83px]" />
...
function Linkedin() {
  return (
    <div className="absolute contents left-[135px] top-[1510px]" data-name="linkedin">
      <div className="absolute bg-[#120a08] border border-[#d4896a] border-solid h-[84px] left-[135px] top-[1510px] w-[83px]" />
      <a className="absolute block cursor-pointer left-[153px] overflow-clip size-[48px] top-[1528px]" data-name="Linkedin" href="https://www.linkedin.com/in/shriya-pothukuchi-751041253/" target="_blank">
        <div className="absolute inset-[8.33%_8.33%_12.5%_8.33%]" data-name="Icon">
          <div className="absolute inset-[-5.26%_-5%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 44 42">
              <g id="Icon">
                <path d={svgPaths.pf842f00} stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" />
                <path d="M10 16H2V40H10V16Z" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" />
                <path d={svgPaths.p335f3460} stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" />
              </g>
            </svg>
          </div>
        </div>
...
function Github() {
  return (
    <div className="absolute contents left-[237px] top-[1510px]" data-name="github">
      <div className="absolute bg-[#120a08] border border-[#d4896a] border-solid h-[84px] left-[237px] top-[1510px] w-[83px]" />
      <a className="absolute block cursor-pointer left-[255px] overflow-clip size-[48px] top-[1528px]" data-name="Github" href="https://github.com/shriyapothukuchi3-beep" target="_blank">
        <div className="absolute inset-[4.06%_10.42%_8.33%_8.33%]" data-name="Icon">
          <div className="absolute inset-[-2.97%_-3.21%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 41.5003 44.5536">
              <path d={svgPaths.p2ccff800} id="Icon" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" />
            </svg>
          </div>
        </div>
      </a>
...
function PicAndLinks() {
  return (
    <div className="absolute contents left-[21px] top-[1154px]" data-name="pic and links">
      <div className="absolute flex h-[323px] items-center justify-center left-[21px] top-[1154px] w-[313px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
        <div className="-rotate-90 flex-none">
          <div className="h-[313px] relative w-[323px]" data-name="profile pic">
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
              <img alt="" className="absolute h-[184.07%] left-[-0.01%] max-w-none top-[-44.73%] w-[100.03%]" src={imgProfilePic} />
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="absolute contents left-[21px] top-[1154px]" data-name="links, pic, about mw">
      ...
      <div className="absolute font-['Plus_Jakarta_Sans',sans-serif] font-normal h-[914px] leading-[0] left-[380px] text-[#120a08] text-[32px] top-[1183px] w-[861px] whitespace-pre-wrap">
        ...
        <p className="leading-[normal] mb-0">&nbsp;</p>
        <p className="leading-[normal] mb-0">{`I'm passionate about exploring new tools and techniques, staying current with design trends, and continuously improving my craft across multiple disciplines.`}</p>
        <p className="leading-[normal]">&nbsp;</p>
      </div>
    </div>
  );
...
function Skills() {
  return (
    <div className="absolute contents left-[64px] top-[2531px]" data-name="skills">
      <DesignTools />
      <AniamtionAnd3D />
      <Deve />
      <Other />
      ...
      <a className="absolute block cursor-pointer left-[540px] overflow-clip size-[42px] top-[3714px]" data-name="mail" href="mailto:shriyapothukuchi3@gmail.com" target="_blank">
        <div className="absolute inset-[16.67%_8.33%]" data-name="icon">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 35 28">
            <path d={svgPaths.p1b74e400} fill="var(--fill-0, #1D1B20)" id="icon" />
          </svg>
        </div>
      </a>
    </div>
...
function EndingBox() {
  return (
    <div className="absolute contents left-[72px] top-[3447px]" data-name="ending box">
      <div className="absolute h-[382px] left-[72px] top-[3447px] w-[1151px]">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1151 382">
          <path d={svgPaths.p14ff7d00} fill="var(--fill-0, #D4896A)" id="Rectangle 30" opacity="0.88" />
        </svg>
      </div>
...
function AboutMe1() {
  return (
    <div className="absolute contents left-px top-[828px]" data-name="about me">
      <Hero />
      <Hero1 />
      <CureentlyExploring />
      <LinksPicAboutMw />
...
export default function AboutMe() {
  return (
    <div className="bg-[#120a08] relative size-full" data-name="About me">
      <Header />
      <AboutMe1 />
    </div>
  );
