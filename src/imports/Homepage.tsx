...
function ProjectsAnsStuff() {
  return (
    <div className="absolute contents font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal left-[108px] text-[#f2d6cc] text-[32px] top-[667px]" data-name="projects ans stuff">
...
function ViewProjectsbutton() {
  return (
    <div className="absolute contents left-[480px] top-[730px]" data-name="view projectsbutton">
      ...
      <div className="absolute font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal h-[38px] leading-[0] left-[500px] text-[32px] text-white top-[761px] w-[223px]">
...
function AboutmeButton() {
  return (
    <div className="absolute contents left-[920px] top-[728px]" data-name="aboutme button">
      ...
      <p className="absolute font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal h-[38px] leading-[normal] left-[967px] text-[32px] text-white top-[761px] w-[190px]">About Me</p>
    </div>
  );
}
...
function SelectedWorks() {
  return (
    <div className="absolute contents left-0 top-[1084px]" data-name="selected works">
      <p className="absolute font-['Clash_Display:Bold',sans-serif] leading-[normal] left-[39px] not-italic text-[#f2d6cc] text-[64px] top-[1084px] whitespace-nowrap">Selected works</p>
...
function ViewProjectsbutton1() {
  return (
    <div className="absolute contents left-[63px] top-[2980px]" data-name="view projectsbutton">
      ...
      <div className="absolute font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal h-[43px] leading-[0] left-[93px] text-[#7a5c54] text-[24px] top-[2991px] w-[181px]">
        <p className="leading-[normal] mb-0">View projects</p>
        <p className="leading-[normal]">&nbsp;</p>
      </div>
    </div>
...
function Design() {
  return (
    <div className="absolute contents left-[34px] top-[2800px]" data-name="design">
      ...
      <div className="absolute font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal h-[30px] leading-[0] left-[54px] text-[#f2d6cc] text-[24px] top-[2810px] w-[285px]">
        <p className="leading-[normal] mb-0">UI/UX · BRAND DESIGN</p>
        <p className="leading-[normal]">&nbsp;</p>
      </div>
      <p className="absolute font-['Clash_Display:Bold',sans-serif] h-[60px] leading-[normal] left-[54px] not-italic text-[#f2d6cc] text-[48px] top-[2852px] w-[463px]">Design that thinks.</p>
      <p className="absolute font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium h-[42px] leading-[normal] left-[54px] text-[#f2d6cc] text-[24px] top-[2924px] w-[440px]">Figma · Research · Systems · Identity</p>
      <ViewProjectsbutton1 />
    </div>
  );
}
...
function Viewproejctsbutton() {
  return (
    <div className="absolute contents left-[693px] top-[2980px]" data-name="viewproejctsbutton">
      ...
      <div className="absolute font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal h-[28px] leading-[0] left-[727px] text-[#7a5c54] text-[24px] top-[2991px] w-[199px]">
        <p className="leading-[normal] mb-0">View projects</p>
        <p className="leading-[normal]">&nbsp;</p>
      </div>
    </div>
...
function Aniamrion() {
  return (
    <div className="absolute contents left-[664px] top-[2799px]" data-name="aniamrion">
      ...
      <div className="absolute font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal h-[44px] leading-[0] left-[693px] text-[#f2d6cc] text-[24px] top-[2810px] w-[343px]">
        <p className="leading-[normal] mb-0">ILLUSTRATION · 3D · MOTION</p>
        <p className="leading-[normal]">&nbsp;</p>
      </div>
      <p className="absolute font-['Clash_Display:Bold',sans-serif] h-[60px] leading-[normal] left-[684px] not-italic text-[#f2d6cc] text-[48px] top-[2852px] w-[368px]">Art that feels.</p>
      <p className="absolute font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium h-[42px] leading-[normal] left-[693px] text-[#f2d6cc] text-[24px] top-[2924px] w-[359px] whitespace-pre-wrap">{`Maya  · Unity · After Effects`}</p>
      <Viewproejctsbutton />
    </div>
  );
}
...
function UxUi() {
  return (
    <div className="absolute contents left-[451px] top-[3462px]" data-name="ux/ui">
      ...
      <div className="absolute font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal h-[28px] leading-[0] left-[485px] text-[#f2d6cc] text-[24px] top-[3477px] w-[164px]">
...
function BrandIdentity() {
  return (
    <div className="absolute contents left-[710px] top-[3462px]" data-name="brand identity">
      ...
      <div className="absolute font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal h-[28px] leading-[0] left-[744px] text-[#f2d6cc] text-[24px] top-[3477px] w-[164px]">
...
function Component3DAnimation() {
  return (
    <div className="absolute contents left-[978px] top-[3462px]" data-name="3d animation">
      ...
      <div className="absolute font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal h-[28px] leading-[0] left-[1012px] text-[#f2d6cc] text-[24px] top-[3477px] w-[164px]">
...
function Illustration() {
  return (
    <div className="absolute contents left-[451px] top-[3552px]" data-name="illustration">
      ...
      <div className="absolute font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal h-[28px] leading-[0] left-[497px] text-[#f2d6cc] text-[24px] top-[3567px] w-[136px]">
...
function MotionDesign() {
  return (
    <div className="absolute contents left-[710px] top-[3554px]" data-name="motion design">
      ...
      <div className="absolute font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal h-[28px] leading-[0] left-[744px] text-[#f2d6cc] text-[24px] top-[3569px] w-[164px]">
...
function Contact() {
  return (
    <div className="absolute contents left-[34px] top-[3148px]" data-name="contact">
      ...
      <p className="absolute font-['Clash_Display:Semibold',sans-serif] leading-[normal] left-[432px] not-italic text-[#f2d6cc] text-[48px] top-[3190px] whitespace-nowrap">Shriya Pothukuchi</p>
      <p className="absolute font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[normal] left-[444px] text-[#f2d6cc] text-[24px] top-[3249px] whitespace-nowrap">Dallas, TX</p>
