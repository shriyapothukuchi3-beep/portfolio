...
function CategoryAnTime() {
  return (
    <div className="absolute contents left-[194px] top-[1477px]" data-name="category an time">
      <Year />
      <Category />
    </div>
  );
...
function Wireframes() {
  return (
    <div className="absolute contents left-[72px] top-[2673px]" data-name="wireframes">
      ...
      <div className="absolute h-[574px] left-[99px] top-[3402px] w-[392px]" data-name="Screenshot 2026-04-02 at 1.05.16 AM 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute left-0 max-w-none size-full top-0" src={imgScreenshot20260402At10516Am1} />
        </div>
      </div>
      <div className="absolute h-[574px] left-[640px] top-[3402px] w-[423px]" data-name="Screenshot 2026-04-02 at 2.51.11 AM 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute left-0 max-w-none size-full top-0" src={imgScreenshot20260402At25111Am1} />
        </div>
      </div>
    </div>
  );
      ...
      <div className="absolute font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal leading-[0] left-[76px] top-[4209px] w-[1127px]">
        ...
        <ul className="list-disc">
          <li className="mb-0 ms-[48px]">
            <span className="leading-[normal]">Home — personalised greeting with live order status pinned at the top, never buried in a menu</span>
          </li>
          <li className="mb-0 ms-[48px]">
            <span className="leading-[normal]">Order Tracking — aerial map, delivery timeline, and step-by-step history with timestamps</span>
          </li>
          <li className="mb-0 ms-[48px]">
            <span className="leading-[normal]">Easy Returns — three-step portal with pickup, drop-off, and in-store options and a clear refund timeline</span>
          </li>
          <li className="mb-0 ms-[48px]">
            <span className="leading-[normal]">Lune Concierge — dark-themed live chat with a named agent, quick reply chips, and online presence indicator</span>
          </li>
          <li className="mb-0 ms-[48px]">
            <span className="leading-[normal]">Quick Actions — book appointment, returns, track order, find store in four taps</span>
          </li>
          <li className="mb-0 ms-[48px]">
            <span className="leading-[normal]">Lune Maison Membership — loyalty tier with progress bar to reward repeat customers</span>
          </li>
          <li className="mb-0 ms-[48px]">
            <span className="leading-[normal]">Care for Your Pieces — product care instructions as a post-purchase delight feature</span>
          </li>
          <li className="ms-[48px]">
            <span className="leading-[normal]">Your Privacy — dedicated data safety screen with four visible commitments, addressing the trust gap no current luxury app tackles</span>
          </li>
        </ul>
      </div>
    </div>
...
function Final() {
  return (
    <div className="absolute contents left-[76px] top-[5849px]" data-name="final">
      <div className="absolute h-[627px] left-[76px] top-[5849px] w-[308px]" data-name="Screenshot 2026-04-04 at 12.32.55 AM 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgScreenshot20260404At123255Am1} />
      </div>
      <div className="absolute h-[627px] left-[895px] top-[5849px] w-[308px]" data-name="Screenshot 2026-04-04 at 12.33.09 AM 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgScreenshot20260404At123309Am1} />
      </div>
      <div className="absolute h-[627px] left-[486px] top-[5849px] w-[308px]" data-name="Screenshot 2026-04-04 at 12.33.22 AM 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgScreenshot20260404At123322Am1} />
      </div>
    </div>
  );
}
...
function Process() {
  return (
    <div className="absolute contents left-[72px] top-[1929px]" data-name="process">
      <Overview />
      <Challenge />
      <Wireframes />
      <Solution />
...
function TotalProcess() {
  return (
    <div className="absolute contents left-[72px] top-[1640px]" data-name="total process">
      <Tools />
      <Viewproject />
      <Process />
    </div>
...
function Lune1() {
  return (
    <div className="absolute contents left-0 top-[346px]" data-name="lune">
      <div className="absolute h-[807px] left-0 top-[346px] w-[1280px]" data-name="Screenshot 2026-04-03 at 7.12.17 PM 2">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[133.61%] left-0 max-w-none top-[-28.34%] w-full" src={imgScreenshot20260403At71217Pm2} />
        </div>
      </div>
      <Heading />
...
export default function Lune() {
  return (
    <div className="bg-[#120a08] relative size-full" data-name="Lune">
      <Header />
