...
function Category() {
  return (
    <div className="absolute contents left-[692px] top-[1448px]" data-name="category">
      ...
      <div className="absolute left-[692px] overflow-clip size-[28px] top-[1450px]" data-name="Tag">
...
function CategoryAndTime() {
  return (
    <div className="absolute contents left-[194px] top-[1448px]" data-name="category and time">
      <Year />
      <Category />
    </div>
  );
...
function Wireframe() {
  return (
    <div className="absolute contents left-[76px] top-[2812px]" data-name="wireframe">
      ...
      <div className="absolute h-[467px] left-[226px] top-[3450px] w-[659px]" data-name="Screenshot 2026-04-03 at 11.48.23 PM 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgScreenshot20260403At114823Pm1} />
      </div>
    </div>
  );
}
...
function Final() {
  return (
    <div className="absolute contents left-[76px] top-[4435px]" data-name="final">
      <div className="absolute h-[628px] left-[76px] top-[4435px] w-[301px]" data-name="Screenshot 2026-04-03 at 11.50.14 PM 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgScreenshot20260403At115014Pm1} />
      </div>
      <div className="absolute h-[628px] left-[468px] top-[4435px] w-[301px]" data-name="Screenshot 2026-04-03 at 11.50.40 PM 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgScreenshot20260403At115040Pm1} />
      </div>
      <div className="absolute h-[628px] left-[861px] top-[4435px] w-[301px]" data-name="Screenshot 2026-04-03 at 11.51.00 PM 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgScreenshot20260403At115100Pm1} />
      </div>
    </div>
  );
}
...
function Meetup() {
  return (
    <div className="absolute contents left-0 top-[355px]" data-name="meetup">
      <Brand />
      <div className="absolute h-0 left-0 top-[1417px] w-[1280.01px]">
...
export default function MeetUp() {
  return (
    <div className="bg-[#120a08] relative size-full" data-name="Meet up">
      <Header />
